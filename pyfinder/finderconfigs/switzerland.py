"""Complete Swiss FinDer configurations for the deployed FinDer version."""
...
# These definitions are deliberately repeated as complete literals. They are
# independent configuration sources, even while their initial scientific
# values are identical, and never inherit omitted values from another profile.
